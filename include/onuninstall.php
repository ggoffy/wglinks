 ...
 */
function xoops_module_pre_uninstall_wglinks(\XoopsModule $module): bool
{
 ...
 */
function xoops_module_uninstall_wglinks(\XoopsModule $module): bool
{
    //    return true;
    ...
    if (\is_file($xmlfile)) {
        if (false === ($delOk = \unlink($xmlfile))) {
            $module->setErrors(\sprintf(_AM_wglinksX_ERROR_BAD_REMOVE, $xmlfile));
        }
    }
